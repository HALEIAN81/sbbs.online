...
<!-- <nav class="topnavbar flex ">
  ...
  <li><a href="apps.blade.php">APPS</a></li>
  <li><a href="contact.blade.php">CONTACT</a></li>
 <li> <a href="about.blade.php">ABOUT</a></li>
 <li> <a href="hosting.blade.php">HOSTING</a></li>
  <li><a href="webdev.blade.php">WEB DEVELOPMENT</a></li>
  <li><a href="support.blade.php">SUPPORT</a></li>
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li class="label1" data-label1="hot">
								<a href="premiumdomains.php">Featured</a>
							</li>
		...
		<div class="menu-mobile">
			<ul class="topbar-mobile">
				<li>
					...
					We Sell Premium Domains, Hosting and Web Services.
					</div>
				</li>
			...
			<ul class="main-menu-m">
				...
				<li>
					<a href="featured.php" class="label1 rs1" data-label1="new">Featured</a>
				</li>
