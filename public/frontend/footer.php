...
<!--
    ...
    <div class="footer-desc mb-6">
      <p>
        We want to be your partner for your domain development and re-sell needs, sign up today to get started!
      </p>
    </div>
    ...
    <div class="grid lg:grid-cols-4 md:grid-cols-2">
      ...
      <div class="mb-6">
        <h5 class="uppercase font-bold mb-2.5">Help</h5>
      ...
      <div class="mb-6">
        <h5 class="uppercase font-bold mb-2.5">Info</h5>
