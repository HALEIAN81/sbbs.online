...
<html lang="en" dir="ltr">
  ...
  <!-- SLEEK CSS -->
  <link id="sleek-css" href="css/g2d.css"  rel="stylesheet" />
          ...
          <div id="sidebar" class="sidebar sidebar-with-footer">
            ...
            <div class="app-brand">
              <a href="/index.php">
                ...
                <span class="brand-name">G2D Dashboard</span>
              </a>
            </div>
                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user-menu">
                    <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                      ...
                      <span class="d-none d-lg-inline-block">Super User</span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-right">
                      <!-- User image -->
                      <li class="dropdown-header">
                        ...
                        <div class="d-inline-block">
                          Super User <small class="pt-1">@go2domainsales.com</small>
                        </div>
                      </li>
        ...
        <div class="content-wrapper">
          <div class="content">
            ...
            <div class="copyright bg-white">
              <p>
                &copy; <span id="copy-year">2021</span> Copyright G2D Dashboard Bootstrap Template by
                <a
                  class="text-primary"
                  href="http://www.go2domainsales.com"
                  target="_blank"
                  >G2D</a
                >.
              </p>
